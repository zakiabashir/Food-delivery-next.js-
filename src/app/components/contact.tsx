  ...
  return ( 
    ...
    data-aos-duration="2000">
      ...
      <h1
            data-aos="fade-up"
            data-aos-duration="2000"
            className="py-2 mt-2 tracking-wider text-gray-900 text-3xl font-semibold text-center max-sm:text-2xl max-md:text-3xl"
          >
            Contact section
          </h1>
        <div
        data-aos="fade-up"
          data-aos-duration="2000"
        className="container px-5 py-14 mx-auto flex sm:flex-nowrap flex-wrap">
